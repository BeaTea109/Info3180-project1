...
class PropertyObject(db.Model):
     ...
     propertyTitle = db.Column(db.String(30), nullable=False)
     propertyDescription = db.Column(db.String(355), nullable=False)
     ...
     propertyPrice = db.Column(db.Float(2), nullable=False)
     propertyLocation = db.Column(db.String(355), nullable=False)
